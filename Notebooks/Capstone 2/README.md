...
[View Documentation for Details](/Notebooks/Capstone%202/Capstone_Final_Report.pdf)
...
[EDA Report](/Notebooks/Capstone%202/02_Exploratory_Data_Analysis%20-%20Student%20Success%20Prediction.ipynb)
...
![Average Total Funding by Income Image](/images/avg_total_funding_by_income.png)
...
[Preprocessing Report](/Notebooks/Capstone%202/03_Preprocessing_Training_Data%20-%20Student%20Success%20Prediction.ipynb)

[ML Report](/Notebooks/Capstone%202/04_Modeling%20-%20Student%20Success%20Prediction.ipynb)
...
[Model Metrics File](/Notebooks/Capstone%202/model_overview.csv)

![Feature Importances Image](/images/feature_importances.png)

- From the feature importances graphic, it's clear that child poverty and attendance (ADA – Average Daily Attendance) are among the most important features, as higher levels of poverty and/or absenteeism tend to predict lower test scores among school districts. 
...
## Predictions
[Final Predictions Notebook](/Notebooks/Capstone%202/05_Predictions%20-%20Student%20Success%20Prediction.ipynb)
